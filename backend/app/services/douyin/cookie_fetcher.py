"""
cookie 获取
参考 jiji262/douyin-downloader 项目实现
自动打开浏览器,用户登录后,自动获取cookie
"""
...
# 默认输出路径：backend/config/douyin_cookies.json
DEFAULT_OUTPUT = Path(__file__).parent.parent.parent.parent / "config" / "douyin_cookies.json"
